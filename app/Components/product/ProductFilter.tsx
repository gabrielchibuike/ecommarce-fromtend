...
//     setFilters((prev) => ({
//       ...prev,
//       main_category: prev.main_category
//         ? ""
//         : `${gender.replace("m", "M")}'s wear`,
//     }));
//   };
...
//     setFilters((prev) => ({
//       ...prev,
//       product_category: prev.product_category ? "" : productCategory,
//     }));
//   };
...
//     setFilters((prev) => ({
//       ...prev,
//       price_max: value[0], // Extract first value from array
//     }));
//   };
...
//     setFilters((prev) => ({
//       ...prev,
//       manufacturer_brand: e.target.value,
//     }));
//   };
...
//           <div>
//             <Slider
//               defaultValue={[7000]} // Matches document price
//               max={10000} // Adjusted for high prices
//               min={0}
//               step={100}
//               value={[filters.price_max]} // Pass as array
//               onValueChange={handlePriceChange} // Pass array directly
//               className="w-full"
//             />
...
//                 id={`color-${color.toLowerCase()}`}
//                 checked={filters.color.includes(color.toLowerCase())}
//                 onCheckedChange={() => handleColorChange(color.toLowerCase())}
//               />
//               <label
//                 htmlFor={`color-${color.toLowerCase()}`}
//                 className="text-sm font-medium leading-none"
...
//                 id={`size-${size.toLowerCase()}`}
//                 checked={filters.size.includes(size.toLowerCase())}
//                 onCheckedChange={() => handleSizeChange(size.toLowerCase())}
//               />
//               <label
//                 htmlFor={`size-${size.toLowerCase()}`}
//                 className="text-sm font-medium leading-none"
